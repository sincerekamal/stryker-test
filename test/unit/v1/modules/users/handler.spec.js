...
describe(`users > handler > `, () => {
  ...
  describe(`create`, () => {
    const { create } = proxyquire("@modules/users/handler", {
      "./payload_validators": {
  ...
  describe(`update`, () => {
    const { update } = proxyquire("@modules/users/handler", {
      "./payload_validators": {
  ...
  describe(`list`, () => {
    const { list } = proxyquire("@modules/users/handler", {
      "./payload_validators": {
  ...
  describe(`delete`, () => {
    const { delete: deleteH } = proxyquire("@modules/users/handler", {
      "./payload_validators": {
  ...
  describe(`get`, () => {
    const { get } = proxyquire("@modules/users/handler", {
      "./payload_validators": {
